<script>
  ...
  const submitFormSelector = document.getElementById ("sbhanger-form");
  const outputDiv = document.getElementById ("outputDiv");

  function htmlPreview () {

    const formURL = '<?php echo site_url ('appgen_actions/sbhanger_preview'); ?>';
  ...
  function pdfPreview () {
    ...
    const formURL = '<?php echo site_url ('appgen_actions/sbhanger_pdf'); ?>';
    var formData = new FormData(submitFormSelector);
